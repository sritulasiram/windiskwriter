...
- (void)setupMenuItems {
    ...
    NSMenuItem *windowMenuBarItem = [[NSMenuItem alloc] init]; {
        ...
        NSMenu *windowMenu = [[NSMenu alloc] initWithTitle: [LocalizedStrings menuTitleWindow]]; {
            ...
            NSMenuItem *toggleLogMenuItem = [[NSMenuItem alloc] initWithTitle: [LocalizedStrings buttonTitleShowLog]
                                                                       action: @selector(toggleLogVisibility)
                                                                keyEquivalent: @"l"]; {
                [windowMenu addItem: toggleLogMenuItem];
            }
        }
    }
...
- (void)setupWindows {
    ...
    {
        NSSize minWindowSize = CGSizeMake(340, 390);
        NSSize maxWindowSize = CGSizeMake(600, 800);
